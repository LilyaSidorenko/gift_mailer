...
<table cellspacing="0" cellpadding="0"
    ...
    <tbody>
    <tr>
        <td><img src="../../src/images/header__email.png" width="100%" style="margin-bottom: 60px;">
            <table cellspacing="0" cellpadding="0" style="width: 100%; padding:0 80px; margin-bottom:30px;">
                ...
                <tr>
                    <td style="padding: 30px 15px; background-color:#ffffff;box-shadow: 2px 2px 9px -1px rgba(0,0,0,0.18);">
                        <p style="color: #000000; font-size: 24px;">Привет, Алина</p><span style="font-size: 16px;"> С Наступающими Праздниками, Алина,  Ваш друг Дмитрий
